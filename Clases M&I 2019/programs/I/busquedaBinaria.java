...
public class Main
{
	public static void main(String[] args)
	{
		...
		valorBusqueda = lee.nextInt(); 	// lectura del valor a buscar dentro del 'arreglo[]'
	...
	public static int busquedaBinaria(int arreglo[], int tam, int valorBusqueda){ // modulo busqueda binaria
	...
	public static void mostrar(int arreglo[], int tam){ 				// este modulo imprimi todos los elementos del 'arreglo[}'
		for (int i = 0 ; i < tam ; i++)
